...
const I18N = [
    'zh' => [
        ...
        'role_admin' => '管理员', 'role_manager' => '经理', 'role_finance_manager' => '财务经理', 'role_supervisor' => '主管', 'role_sales' => '销售员', 'role_warehouse' => '仓库',
        'nav_roles' => '权限设置', 'page_roles' => '权限设置', 'sub_roles' => '按角色配置模块访问', 'btn_save_perms' => '保存权限', 'col_module' => '模块', 'perms_hint' => '勾选 = 该角色可访问对应模块/数据；管理员始终拥有全部权限。「销售业绩」控制能否看到看板上的全员业绩。', 'nav_performance' => '销售业绩',
    ...
    'id' => [
        ...
        'role_admin' => 'Admin', 'role_manager' => 'Manager', 'role_finance_manager' => 'Manajer Keuangan', 'role_supervisor' => 'Supervisor', 'role_sales' => 'Sales', 'role_warehouse' => 'Gudang',
        'nav_roles' => 'Hak Akses', 'page_roles' => 'Pengaturan Hak Akses', 'sub_roles' => 'Atur akses modul per peran', 'btn_save_perms' => 'Simpan', 'col_module' => 'Modul', 'perms_hint' => 'Centang = peran dapat mengakses modul/data; Admin selalu penuh. "Kinerja Sales" mengontrol tampil kinerja semua sales di dasbor.', 'nav_performance' => 'Kinerja Sales',
