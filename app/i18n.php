...
const I18N = [
    'zh' => [
        ...
        'order' => '订单', 'reserved' => '预留', 'not_found' => '页面不存在', 'back_home' => '返回首页', 'incl_tax' => '含税', 'incl_ppn' => '其中含 PPN 12%', 'pretax_subtotal' => '税前 Subtotal (DPP)', 'search_product' => '搜索 SKU / 颜色 / 规格', 'welcome_back' => '欢迎回来', 'assign_sales' => '指定销售（负责人）', 'assign_sales_ph' => '输入或选择销售姓名',
        // inventory
    ...
    'id' => [
        ...
        'order' => 'Pesanan', 'reserved' => 'Dipesan', 'not_found' => 'Halaman tidak ditemukan', 'back_home' => 'Kembali ke Beranda', 'incl_tax' => 'incl. PPN', 'incl_ppn' => 'termasuk PPN 12%', 'pretax_subtotal' => 'Subtotal sebelum pajak (DPP)', 'search_product' => 'Cari SKU / Warna / Spek', 'welcome_back' => 'Selamat datang', 'assign_sales' => 'Tetapkan Sales (PIC)', 'assign_sales_ph' => 'Ketik atau pilih nama sales',
