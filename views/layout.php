    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav">
            ...
            <?php if (can_access('inventory')): ?>
                <a class="nav-item<?= $cur !== 'inventory.ask' ? $active('inventory') : '' ?>" href="<?= url('inventory.index') ?>"><span class="nav-icon">▣</span> <?= t('nav_inventory') ?></a>
                <a class="nav-item<?= $cur === 'inventory.ask' ? ' active' : '' ?>" href="<?= url('inventory.ask') ?>"><span class="nav-icon">⌕</span> <?= t('nav_ask') ?></a>
            <?php endif; ?>
